	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow admin user to perform 'admin' and 'delete' actions
				'actions'=>array('admin','delete','index','view','create','update','ajaxview'),
				//'users'=>array('*'),
				'roles'=>array('Admin'),
			),
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Post']))
		{
			...
			if($model->save()) {
				...
				$this->redirect('/post/'.$model->id.'-'.$model->slug);
			}
